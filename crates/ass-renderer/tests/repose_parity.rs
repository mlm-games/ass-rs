...
//!
//! - reference: `ass-renderer`'s `SoftwarePipeline` + `SoftwareBackend`
...
use ass_renderer::backends::repose::{covered_pixels, layers_to_scene};
use ass_renderer::pipeline::{IntermediateLayer, Pipeline, SoftwarePipeline};
