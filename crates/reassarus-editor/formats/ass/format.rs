...
//!
//! Provides the [`AssFormat`] type, which reuses reassarus-core's parsing and
...
/// ASS format handler that reuses reassarus-core functionality
#[derive(Debug)]
...
impl FormatImporter for AssFormat {
    ...
    fn import_from_reader(
        ...
        // Validate that it's parseable by reassarus-core
        ...
        if let Some(reassarus_core::parser::ast::Section::ScriptInfo(script_info)) =
            script.find_section(reassarus_core::parser::ast::SectionType::ScriptInfo)
        {
...
impl FormatExporter for AssFormat {
    ...
    fn export_to_writer(
        ...
        let content = if options.preserve_formatting {
            ...
            // Use reassarus-core's serialization for normalized output
