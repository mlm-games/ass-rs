//! Core validation logic bridging reassarus-core analysis and basic checks.
//!
...
use reassarus_core::analysis::linting::IssueSeverity;
#[cfg(feature = "analysis")]
...
impl LazyValidator {
    /// Validate using reassarus-core's ScriptAnalysis
    #[cfg(feature = "analysis")]
    pub(super) fn validate_with_core(
        ...
        // Parse and analyze with reassarus-core
    ...
    /// Fallback validation without reassarus-core analysis
