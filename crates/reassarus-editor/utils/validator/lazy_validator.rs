...
//! and the reassarus-core analysis configuration used during validation.

use super::{ValidationResult, ValidatorConfig};

#[cfg(feature = "analysis")]
use reassarus_core::analysis::{AnalysisConfig, ScriptAnalysisOptions};

#[cfg(feature = "std")]
use std::time::Instant;

/// Lazy validator that wraps reassarus-core's ScriptAnalysis
///
