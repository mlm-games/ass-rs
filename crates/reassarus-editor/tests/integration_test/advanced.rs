...
mod advanced_tests {
    use reassarus_editor::events::DocumentEvent;
    ...
    fn test_extension_loading_and_state() {
        ...
        manager
            .load_extension(Box::new(
                reassarus_editor::extensions::builtin::syntax_highlight::SyntaxHighlightExtension::new(),
            ))
            .unwrap();

        manager
            .load_extension(Box::new(
                reassarus_editor::extensions::builtin::auto_complete::AutoCompleteExtension::new(),
            ))
            .unwrap();
