...
fn test_line_column_errors() {
    ...
    assert!(reassarus_editor::core::LineColumn::new(0, 1).is_err()); // Line 0 doesn't exist
    assert!(reassarus_editor::core::LineColumn::new(1, 0).is_err()); // Column 0 doesn't exist
}
