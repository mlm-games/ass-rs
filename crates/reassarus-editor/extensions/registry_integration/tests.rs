//! Tests for the registry integration glue between reassarus-editor extensions and
//! reassarus-core's plugin system.
...
fn test_custom_tag_handler_registration() {
    use reassarus_core::plugin::{TagHandler, TagResult};
...
fn test_custom_section_processor_registration() {
    use reassarus_core::plugin::{SectionProcessor, SectionResult};
...
fn test_full_integration() {
    ...
    let result = reassarus_core::parser::Script::builder()
