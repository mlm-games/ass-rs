...
//!
//! Holds the reassarus-core [`ExtensionRegistry`] together with the editor extensions
...
use reassarus_core::plugin::{ExtensionRegistry, SectionProcessor, TagHandler};

#[cfg(not(feature = "std"))]
use alloc::{boxed::Box, format, string::String, vec::Vec};

/// Wrapper that connects editor extensions to reassarus-core's ExtensionRegistry
pub struct RegistryIntegration {
    /// The reassarus-core extension registry
