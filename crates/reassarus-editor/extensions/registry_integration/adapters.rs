//! Adapters bridging editor extensions to reassarus-core handler traits.
//!
//! Provides [`EditorTagHandlerAdapter`] and [`EditorSectionProcessorAdapter`],
//! which let editor extensions act as reassarus-core `TagHandler`s and
//! `SectionProcessor`s respectively.

use crate::extensions::EditorExtension;
use reassarus_core::plugin::{SectionProcessor, SectionResult, TagHandler, TagResult};
