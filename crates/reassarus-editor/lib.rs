...
//!
//! `reassarus-editor` provides an interactive editing interface built on top of `reassarus-core`,
...
//! - **Incremental parsing**: <1ms edits, <5ms re-parses via reassarus-core's streaming parser
//! - **Fluent APIs**: Ergonomic builders and method chaining for all operations
//!
//! ## ⚡ High Performance
//! - **Zero-copy editing**: Direct manipulation of reassarus-core's zero-copy spans
...
//!
//! ```
//! # use reassarus_editor::{EditorDocument, StyleBuilder};
...
//! # Feature Flags
//!
//! reassarus-editor uses a two-tier feature system for maximum flexibility:
//!
//! ## Main Flavors
