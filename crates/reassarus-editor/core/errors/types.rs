...
//!
//! Defines the main `EditorError` enum that wraps `CoreError` from reassarus-core
...
/// Main error type for reassarus-editor operations
///
/// Wraps `CoreError` from reassarus-core and adds editor-specific error cases
/// for document management, command execution, and session handling.
#[cfg_attr(feature = "std", derive(Error))]
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum EditorError {
    /// Errors from reassarus-core
