...
use reassarus_core::parser::ast::Section;
...
impl EditorDocument {
    ...
    /// # use reassarus_editor::core::builders::EventBuilder;
                    ...
                    for event in events {
                        if event_count == index {
                            ...
                            let mut builder = match event.event_type {
                                reassarus_core::parser::ast::EventType::Dialogue => {
                                    EventBuilder::dialogue()
                                }
                                reassarus_core::parser::ast::EventType::Comment => {
