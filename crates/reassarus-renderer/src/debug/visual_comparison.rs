...
impl VisualComparison {
    ...
    pub fn render_with_debug(
        ...
        // Get script info
        use reassarus_core::parser::ast::SectionType;
        let play_res_x = if let Some(reassarus_core::parser::ast::Section::ScriptInfo(info)) =
        ...
        let play_res_y = if let Some(reassarus_core::parser::ast::Section::ScriptInfo(info)) =
            script.find_section(SectionType::ScriptInfo)
        {
