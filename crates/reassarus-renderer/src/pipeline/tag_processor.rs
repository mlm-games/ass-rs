//! Tag processing for events using reassarus-core's tag parsing
...
use reassarus_core::analysis::events::{OverrideTag, TextAnalysis};
use reassarus_core::ExtensionRegistry;
...
pub fn process_event_tags(
    ...
    // Note: reassarus-core's TextAnalysis already converts \N, \n, \h to actual characters
...
pub fn parse_color(args: &str) -> Option<[u8; 4]> {
    // Use reassarus-core's color parsing
    reassarus_core::utils::parse_bgr_color(args).ok()
}
