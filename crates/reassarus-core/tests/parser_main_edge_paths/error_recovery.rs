...
Title: Test";
    ...
    if let Ok(script) = result {
        ...
        for issue in script.issues() {
            ...
            assert!(matches!(
                issue.severity,
                reassarus_core::parser::IssueSeverity::Warning
                    | reassarus_core::parser::IssueSeverity::Error
                    | reassarus_core::parser::IssueSeverity::Info
                    | reassarus_core::parser::IssueSeverity::Critical
            ));
        }
    } else {
