...
///
/// ```rust
/// # use reassarus_core::analysis::events::scoring::calculate_animation_score;
/// # use reassarus_core::analysis::events::tags::OverrideTag;
...
///
/// ```rust
/// # use reassarus_core::analysis::events::scoring::calculate_complexity_score;
