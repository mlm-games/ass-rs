...
///
/// ```rust
/// # use reassarus_core::analysis::events::utils::find_overlapping_dialogue_events;
/// # use reassarus_core::analysis::events::dialogue_info::DialogueInfo;
/// # use reassarus_core::parser::Event;
