//! [`AccessibilityRule`] implementation and its accessibility checks.
//!
//! Houses the rule type, its [`LintRule`] implementation, and the per-event
//! duration, reading-speed, and text-length checks it performs.
...
///
/// ```rust
/// use reassarus_core::analysis::linting::rules::accessibility::AccessibilityRule;
