//! [`EncodingRule`] implementation for detecting encoding and character issues.
//!
//! Provides the [`EncodingRule`] lint rule along with its helper checks for
//! individual events and the script-info section.
...
///
/// ```rust
/// use reassarus_core::analysis::linting::rules::encoding::EncodingRule;
