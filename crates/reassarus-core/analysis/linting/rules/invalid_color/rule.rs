//! `InvalidColorRule` implementation and its color-validation helpers.
//!
//! Houses the rule type, its [`LintRule`] implementation, and the inherent
//! helpers that validate style color fields and color override tags.
...
///
/// ```rust
/// use reassarus_core::analysis::linting::rules::invalid_color::InvalidColorRule;
/// use reassarus_core::analysis::linting::LintRule;
/// use reassarus_core::{Script, ScriptAnalysis};
///
...
impl InvalidColorRule {
    ...
    pub(super) fn parse_color_tag(tag_part: &str) -> Option<(String, String)> {
