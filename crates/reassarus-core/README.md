...
- **nostd compatible**: Works in embedded environments
...
```toml
[dependencies]
reassarus-core = { version = "0.1", features = ["analysis"] }
```
...
```rust
use reassarus_core::analysis::linting::{lint_script, LintConfig};
...
```rust
use reassarus_core::parser::streaming::StreamingParser;
